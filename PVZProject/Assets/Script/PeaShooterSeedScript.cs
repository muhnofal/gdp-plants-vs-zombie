...
public class PeaShooterSeedScript : MonoBehaviour
{
    ...
    public void StartRecharge()
    {
        ...
        StartCoroutine("WaitTimePea");
    }

    IEnumerator WaitTimePea()
    {
        yield return new WaitForSeconds(prefabPlant.GetComponent<PeaShooterScript>().timeRecharge);
        yield return
        canPlant = true;
    }
}
